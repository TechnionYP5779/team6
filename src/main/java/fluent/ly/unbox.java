...
@SuppressWarnings("null") public enum unbox {
  ...
  public static boolean @NotNull [] unboxBoolean(final @NotNull Boolean[] bs) {
  ...
  public static byte @NotNull [] unboxByte(final @NotNull Byte[] bs) {
  ...
  public static char @NotNull [] unboxChar(final @NotNull Character[] cs) {
  ...
  public static short @NotNull [] unboxCollection(final @NotNull Collection<Short> ss) {
  ...
  public static double @NotNull [] unboxDouble(final @NotNull Double[] ds) {
  ...
  public static float @NotNull [] unboxfloat(final Float[] fs) {
  ...
  public static int @NotNull [] unboxInteger(final @NotNull Integer[] is) {
  ...
  public static long @NotNull [] unboxLong(final @NotNull Long[] ls) {
   ...
   * @return an equivalent array of <code><b>short</b></code>s. */
  public static short @NotNull [] unboxShort(final @NotNull Short[] ss) {
