...
/** <br>
 * This class contains in her three different class of specific type to range.<br>
 * One for above bounded range, one for below bounded range and one for finite range.<br>
 * In addition, this class return some known ranges like natural , negative odd and positive odd 
 * ranges.<br>
...
public class AnyRange {
  ...
  /** <br>
   * This class is the type of elements AnyRange and the other three specific range throw 
   * @author Elizabeth Yeshaayahu
   * @since November 2018 */
   ...
   * It offers methods like changing the upper bound , getting the step of the range , etc.<br>
   * @author Elizabeth Yeshaayahu
   * @since November 2018 */
  public static class BoundedAboveRange {
    ...
    * @return upper step
     ...
     * @return new finite range with the old upper bound and step and with the new lower bound
    ...
    /**
     * @return the sum of the upper bound and the step if it negative otherwise the negated of the sum
     */
    ...
    /**
     * @param ¢      : object
     * @return true if ¢'s type is BoundedAboveRange and upper bounds and steps are identical
     */
     ...
     * @return object from type BoundedAboveRange with the  highest upper bound and with the smaller step
     */
    ...
    /**
     * @param ¢      : from type BoundedAboveRange
     * @return true if current upper bound is smaller or identical to the upper bound of the parameter
     */
   ...
   * It offers methods like changing the below bound , getting the step of the range , etc.<br>
   * @author Elizabeth Yeshaayahu
   * @since November 2018 */
  public static class BoundedBelowRange {
     ...
     * @return new finite range with the old lower bound and step and with the new upper bound
     */
    ...
    /**
     * @return the sum of the lower bound and the step if it positive otherwise the negated of the sum
     */
    @Override public int hashCode() {
    ...
    /**
     * @param ¢      : object
     * @return true if ¢'s type is BoundedBelowRange and lower bounds and steps are identical
     */
    @Override public boolean equals(final Object ¢) {
     ...
     * @return object from type BoundedBelowRange with the smaller lower bound and with the smaller step
     */
    ...
    /**
     * @param ¢      : from type BoundedBelowRange
     * @return true if current lower bound is bigger or identical to the upper bound of the parameter
     */
  ...
  public static class FiniteRange {
    ...
    /**
     * @return true if the current upper bound is smaller the the upper bound of the parameter
     * and if the lower bound is bigger then the lower bound of the parameter
     * otherwise false
     */
     ...
     * @return object from type FiniteRange with the smaller lower bound and bigger upper bound
     * and with the smaller step
     */
    ...
    /**
     * @return true if the current upper bound is smaller the the upper bound of the parameter
     * or if the lower bound is bigger then the lower bound of the parameter
     * otherwise false
     */
    ...
    /**
     * @return the lower bound and the upper bound like this [lower bound,upper bound]
     */
    @Override public String toString() {
