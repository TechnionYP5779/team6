...
/** <br>
 * This class represents a Rectangle and was constructed with
 * the TDD method. <br>
 * A Rectangle is constructed with two {@link Point}s which represent
 * two vertices in the Rectangle: top-left, and bottom-right. <br>
 * The class's methods retrieves Area, Perimeter, Length and Width, all calculated
...
public class Rectangle {
   ...
   * @return   A Rectangle instance with specified vertices and two more (top-right and
   * bottom-left) based on the specified vertices.
   * @throws InvalidParameterException if both Points represent the same location.
   * 
   */
