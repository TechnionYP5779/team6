...
/** <br>
 * This class represents a Point and was constructed with
 * the TDD method. <br>
 * A Point is constructed with two parameters which represent
 * the location of the Point: x and y, both double values. <br>
 * @author Idan Hadad
 * @since November 2018 */
public class Point {
  double x;
