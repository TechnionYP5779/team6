...
public class Time {
  ...
  public static class DayTime {
    ...
    /**
     * @param hour an integer representing an hour in a 24 hour day. Range accepted: 0 - 23.
     * @param minute an integer representing a minute in an hour. Range accepted: 0 - 59.
     * @exception If an integer outside the ranges is provided an IllegalArgumentException is thrown.
     */
     ...
     * @return an integer according to which is earlier in the day.
     * 1 if this instance is later.
     * 0 if they are both at the same time.
     * -1 if this instance is earlier.
     */
    ...
    /**
     * @param ¢ another DayTime instance to be compared to this instance.
     * @return whether this instance is earlier than and not equal to the parameter.
     */
    ...
    /**
     * @param ¢ another DayTime instance to be compared to this instance.
     * @return whether this instance is later than and not equal to the parameter.
     */
     ...
     * @return the difference in minutes between the DayTimes.
     * Is negative if this instance is later than the parameter.
     */
   ...
   * @fluent.ly.ClassDesc Enum for each day of the week, doesn't include any logic.
   */
  public enum WeekDay {
   ...
   * @exception If the parameter 'from' is not earlier than the parameter 'to', an IllegalArgumentException is thrown.
   */
   ...
   * @return True if the parameter is in the time range of this instance regardless if range, including the edges.
   * False, otherwise.
   */
   ...
   * @return true if there is a conflict between the ranges.
   * A conflict occurs if the ranges are overlapping or they are less than 60 minutes apart and they are both on the same day.
   */
