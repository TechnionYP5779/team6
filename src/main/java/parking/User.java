...
// // seller info
// private final Map<Integer, ParkingSpot> ownedParkingSpots; // parking spots
// this user owns
// private final Map<Integer, Map<Integer, RentSlot>> freeRentSlots; // slots of
// parking ready for renting
// private final Map<Integer, Map<Integer, RentSlot>> usedRentSlots; // slots of
// parking which already rented to someone
// // buyer info
//
// /** initialize a user, including name, last name, phone, and initialization
// of
...
// @Override public void letParkingSlot(final Buyer b, final int spotID, final
// int slotID) {
// if (spotID < 0 || slotID < 0 || !checkParkingBelongsToUser(spotID))
// throw new IllegalArgumentException();
// final Map<Integer, RentSlot> usedRentSlotsOfPSpot =
// usedRentSlots.get(box.it(spotID));
// if (usedRentSlotsOfPSpot.containsKey(box.it(slotID)))
// throw new IllegalArgumentException();
// final Map<Integer, RentSlot> freeRentSlotsOfPSpot =
// freeRentSlots.get(box.it(spotID));
...
// }
//
// /** @see parking.Seller#addRentSlot(parking.ParkingSpot, parking.Time,
// double)
// * @fluent.ly.Changed
// * @throws NullPointerException if parking spot or time given are null
// * @throws IllegalArgumentException if spotID is not associated with parking
// * spot
// * @throws IllegalArgumentException if time is conflicted with another rent
// slot
// * of same parking spot */
// @Override public void addRentSlot(final ParkingSpot s, final Time t, final
// double price) {
// if (s == null || t == null)
// throw new NullPointerException();
// if (price < 0 || !checkParkingBelongsToUser(s.getId()))
// throw new IllegalArgumentException();
// final Map<Integer, RentSlot> freeRentSlotsOfS =
// freeRentSlots.get(box.it(s.getId()));
...
// * @throws IllegalArgumentException if spotID is not associated with parking
// * spot */
// @Override public void updateParkingSpotPrice(final int spotID, final double
// change) {
// if (spotID < 0 || !checkParkingBelongsToUser(spotID))
// throw new IllegalArgumentException();
...
// * @throws IllegalArgumentException if spotID is not associated with parking
// * spot */
// @Override public void updateRentSlotPrice(final int spotID, final int slotID,
// final double price) {
// if (spotID < 0 || slotID < 0 || price < 0 ||
// !checkParkingBelongsToUser(spotID))
// throw new IllegalArgumentException();
...
// return User.union(freeRentSlots.get(box.it(spotID)).values(),
// usedRentSlots.get(box.it(spotID)).values());
// }
//
...
// private static <T> List<T> union(final Collection<T> list1, final
// Collection<T> list2) {
...
// * @fluent.ly.Changed */
// @Override public void rentParkingSlot(final Seller s, final int spotID, final
// int slotID) {
...
// * @fluent.ly.Changed */
// @Override public void unrentParkingSlot(final Seller s, final int spotID,
// final int slotID) {
