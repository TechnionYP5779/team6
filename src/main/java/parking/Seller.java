...
public interface Seller {
  ...
  /** Remove a parking spot of a seller. Will handle all the rent slots associated
   * with this parking spot, and will notify the buyers of these slots, if exist.
   * @param spotID the id of the parking spot */
  void removeParkingSpot(int spotID);

  /** Remove a rent slot that belongs to the seller. Will notify the buyer of this
   * slot, if exist.
   * @param spotID the id of the parking associated with the slot that will be
   *               removed
   * @param slotID the id of the rent slot */
  void removeRentSlot(int spotID, int slotID);

  /** Updates all rent slots prices associated to the parking spot Will notify the
   * buyers of these slots, if exist.
   * @param spotID the id of the parking spot which its slots's price need update
   * @param change the amount that will be added to all rent slots belong to the
   *               parking spot */
  void updateParkingSpotPrice(int spotID, double change);

  /** updates a rent slot price. Will notify the buyer of this slot, if exist.
   * @param spotID the id of the parking associated with the slot which its price
   *               needs update
   * @param slotID the id of the rent slot
   * @param price  the new price of the rent slot */
  void updateRentSlotPrice(int spotID, int slotID, double price);

  /** @return list of parking spots which belong to the seller, arranged in order
   *         of income parking spots. */
  List<ParkingSpot> getOwnedParkingSpots();

//  /** @param spotID the id of the parking spot it slots will be returned
//   * @return list of the slots associated with the parking spot. No order
//   *         guaranteed. */
...
//
//  /** @param spotID the id of the parking spot it non-rented slots will be
//   *               returned
//   * @return list of all non-rented slots associated with the parking spot. No
//   *         order guaranteed. */
//  List<RentSlot> getAllFreeSlotsBySpotID(int spotID);
//
//  /** @param spotID the id of the parking spot it rented slots will be returned
//   * @return list of rented slots associated with the parking spot. No order
//   *         guaranteed. */
...
//  /** @return list of all unrented slots belong to this seller. Arranged in order
//   *         of income parking spots, no second order guaranteed on rent slots. */
//  List<RentSlot> getAllFreeRentSlots();
//
//  /** @return list of all rented slots belong to this seller. Arranged in order of
//   *         income parking spots, no second order guaranteed on rent slots. */
