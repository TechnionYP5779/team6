...
public class PairTest {
  ...
  @SuppressWarnings("static-method") @Test public void testHashCode() {
    Pair<String, String> ps1 = new Pair<>("abcd", "abcd");
    Pair<String, String> ps2 = new Pair<>("abcd", "abcd");
    Pair<String, String> ps3 = new Pair<>("defg", "abcd");
    Pair<String, String> ps4 = new Pair<>("abcd", "defg");
  ...
  @SuppressWarnings("static-method") @Test public void testPairArrays() {
    //two empty arrays:
    Pair<Integer,Integer> size_two[] = Pair.makePairs(2);
    Pair<Integer,Integer> size_two_also[] = Pair.makePairs(2);
    Pair<Integer, Integer> p1 = new Pair<>(Integer.valueOf(1),Integer.valueOf(1));
    Pair<Integer, Integer> p2 = new Pair<>(Integer.valueOf(1),Integer.valueOf(2));
