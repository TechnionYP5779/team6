...
@SuppressWarnings({ "null", "static-method", "boxing" }) public class theTest {
  ...
  @Test public void theTestpenultimateOf3() {
    ...
    arr.add(2);
    arr.add(3);
    azzert.that(Integer.valueOf(2), is(the.penultimateOf(arr)));
  }
  ...
  @Test public void theTestPreviousNotNull() {
    ...
    arr.add(2);
    arr.add(3);
    azzert.that(Integer.valueOf(2), is(the.previous(3, arr)));
  }
  ...
  @Test public void theTestHeadNotNull() {
    ...
    arr.add(2);
    arr.add(3);
    azzert.that(Integer.valueOf(1), is(the.headOf(arr)));
  }
  ...
  @Test public void theTestRest() {
    ...
    res.add(2);
    res.add(3);
    azzert.that(res, is(the.rest(1, arr)));
  }
  ...
  @Test public void theTestLastOfNotNull() {
    ArrayList<Integer> arr = new ArrayList<>();
    arr.add(1);
    azzert.that(Integer.valueOf(1), is(the.lastOf(arr)));
  }
  ...
  @Test public void theTestOnlyOneOfNotNull() {
    ArrayList<Integer> arr = new ArrayList<>();
    arr.add(1);
    azzert.that(Integer.valueOf(1), is(the.onlyOneOf(arr)));
  }
  ...
  @Test public void theTestsecondOfNotNull() {
    ...
    arr.add(2);
    arr.add(3);
    azzert.that(Integer.valueOf(2), is(the.secondOf(arr)));
  }
  ...
  @Test public void theTestLastOfArray() {
    azzert.that(Integer.valueOf(4), is(the.lastOf(new Integer[] { 1, 2, 3, 4 })));
  }
  ...
  @Test public void theTestLastNotNull() {
    ...
    arr.add(2);
    arr.add(3);
    azzert.that(Integer.valueOf(3), is(the.last(arr)));
  }
