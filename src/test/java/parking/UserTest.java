...
// "Kazan", 30);
// List<Address> yossiAdd = new ArrayList<>();// list of addresses of parking
// spots
// yossiAdd.add(a1);
// yossiAdd.add(a2);
// yossiAdd.add(a3);
...
// List<Address> tamarAdd = new ArrayList<>();// list of addresses of parking
// spots
// tamarAdd.add(a5);
// tamarAdd.add(a6);
...
// yossi.addRentSlot(pOfYossi1, new Time(Time.WeekDay.Sunday, new
...
// yossi.addRentSlot(pOfYossi1, new Time(Time.WeekDay.Monday, new
// Time.DayTime(10, 53), new Time.DayTime(13, 30)), 23.5);
// yossi.addRentSlot(pOfYossi1, new Time(Time.WeekDay.Monday, new
// Time.DayTime(14, 53), new Time.DayTime(20, 30)), 30);
// yossi.addRentSlot(pOfYossi1, new Time(Time.WeekDay.Saturday, new
// Time.DayTime(14, 53), new Time.DayTime(16, 30)), 30);
// check = false;
// try {
// yossi.addRentSlot(pOfYossi1, new Time(Time.WeekDay.Saturday, new
// Time.DayTime(14, 53), new Time.DayTime(16, 30)), 30);
...
// yossi.addRentSlot(pOfYossi2, new Time(Time.WeekDay.Monday, new
// Time.DayTime(10, 53), new Time.DayTime(13, 30)), 23.5);
// yossi.addRentSlot(pOfYossi2, new Time(Time.WeekDay.Monday, new
// Time.DayTime(14, 53), new Time.DayTime(20, 30)), 30);
// yossi.addRentSlot(pOfYossi2, new Time(Time.WeekDay.Saturday, new
// Time.DayTime(14, 53), new Time.DayTime(16, 30)), 30);
// azzert.that(pOfYossi2.getNumOfSlots(), is(3));
// List<RentSlot> yossiFreeRentSlotsOfP =
// yossi.getAllFreeSlotsBySpotID(pOfYossi2.getId());
// azzert.that(yossiFreeRentSlotsOfP.size(), is(3));
// yossi.removeRentSlot(pOfYossi2.getId(),
// yossiFreeRentSlotsOfP.get(0).getId());
...
// yossi.addRentSlot(pOfYossi1, new Time(Time.WeekDay.Saturday, new
// Time.DayTime(14, 53), new Time.DayTime(16, 30)), 30);
// List<RentSlot> freeRS = yossi.getAllFreeRentSlots(), usedRS =
// yossi.getAllUsedRentSlots();
...
// check = false;
// try {
// ((User) tamar).letParkingSlot(yossi, pOfYossi1.getId(),
// freeRS.get(0).getId());
// } catch (IllegalArgumentException e) {
// check = true;
// }
...
// // property)
// List<RentSlot> freeRentSlots =
// yossi.getAllFreeSlotsBySpotID(pOfYossi1.getId());
...
// yossi.updateRentSlotPrice(pOfYossi2.getId(), freeRentSlots.get(0).getId(),
// 35);
// yossi.updateRentSlotPrice(pOfYossi2.getId(), freeRentSlots.get(2).getId(),
// 40);
...
// check = false;
// try {
// tamar.updateRentSlotPrice(pOfYossi2.getId(), freeRentSlots.get(0).getId(),
// -1);
// } catch (IllegalArgumentException e) {
// check = true;
// }
...
// yossi.addRentSlot(p0, new Time(Time.WeekDay.Sunday, new Time.DayTime(10, 53),
// new Time.DayTime(13, 30)), 23.5);
// yossi.addRentSlot(p0, new Time(Time.WeekDay.Monday, new Time.DayTime(10, 53),
// new Time.DayTime(13, 30)), 23.5);
// yossi.addRentSlot(p0, new Time(Time.WeekDay.Monday, new Time.DayTime(14, 53),
// new Time.DayTime(20, 30)), 30);
// yossi.addRentSlot(p0, new Time(Time.WeekDay.Saturday, new Time.DayTime(14,
// 53), new Time.DayTime(16, 30)), 30);
// yossi.addRentSlot(p1, new Time(Time.WeekDay.Sunday, new Time.DayTime(10, 53),
// new Time.DayTime(13, 30)), 23.5);
// yossi.addRentSlot(p1, new Time(Time.WeekDay.Monday, new Time.DayTime(10, 53),
// new Time.DayTime(13, 30)), 23.5);
// yossi.addRentSlot(p1, new Time(Time.WeekDay.Monday, new Time.DayTime(14, 53),
// new Time.DayTime(20, 30)), 30);
// yossi.addRentSlot(p1, new Time(Time.WeekDay.Saturday, new Time.DayTime(14,
// 53), new Time.DayTime(16, 30)), 30);
...
// yossi.letParkingSlot(tamar, rs1.getParkingSpot().getId(),
// yossi.getAllFreeSlotsBySpotID(p1.getId()).get(0).getId());
// yossi.letParkingSlot(tamar, rs1.getParkingSpot().getId(), rs1.getId());
// azzert.that(yossi.getAllRentSlots().size(), is(8));
// azzert.that(yossi.getAllFreeRentSlots().size(), is(6));
