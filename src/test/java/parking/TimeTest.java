...
public class TimeTest {
  ...
  @Test
  public void testDayTimeRestrictions() {
    Time.DayTime $;
    try {
  ...
  public void testDayTimeEquals() {
    Time.DayTime $ = new Time.DayTime(1, 30);
  ...
  @Test
  public void testRelativityMethods() {
  ...
  @Test
  public void testConficting() {
    Time $ = new Time(WeekDay.Friday,new Time.DayTime(6, 0),new Time.DayTime(8, 20));
