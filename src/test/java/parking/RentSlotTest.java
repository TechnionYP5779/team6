...
// // add rent slot to the first parking spot of Yossi.No buyer to this rent
// slot
...
// //// try adding rent slot that its time conflict with the rent slot just
// added
// check = false;
// try {
// yossi.addRentSlot(pOfYossi1, new Time(Time.WeekDay.Saturday, new
...
// check = false;
// try {
// new RentSlot(null, pOfYossi1, new Time(Time.WeekDay.Monday, new
// Time.DayTime(10, 53), new Time.DayTime(13, 30)), 30.0);
...
// check = false;
// try {
// new RentSlot(yossi, null, new Time(Time.WeekDay.Monday, new Time.DayTime(10,
// 53), new Time.DayTime(13, 30)), 30.0);
// } catch (NullPointerException e) {
// check = true;
// }
// assert check;
...
// }
// assert check;
// // check that only owner of parking spot can add a rent slot of the parking
// spot
// check = false;
// try {
// new RentSlot((User) tamar, pOfYossi1, new Time(Time.WeekDay.Monday, new
// Time.DayTime(10, 53), new Time.DayTime(13, 30)), 30.0);
// } catch (IllegalArgumentException e) {
// check = true;
// }
